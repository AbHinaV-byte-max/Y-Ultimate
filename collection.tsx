...
export function useCollection<T = any>(
  ...
  useEffect(() => {
    // This check is now enforced.
    if(memoizedTargetRefOrQuery && !memoizedTargetRefOrQuery.__memo) {
      throw new Error('A query/reference passed to useCollection was not properly memoized with useMemoFirebase. This will cause performance issues.');
    }
